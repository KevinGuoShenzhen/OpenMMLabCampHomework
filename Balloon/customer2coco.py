...
def cutom2coco(json_path, img_prefix_path, target_path="test.json"):
    ...
    mmcv.dump(coco, target_path, indent=4)

# train
cutom2coco(
    json_path="/HOME/scz0bdm/run/homework/balloon/train/via_region_data.json",
    img_prefix_path="/HOME/scz0bdm/run/homework/balloon/train",
    target_path="/HOME/scz0bdm/run/homework/balloon/train/coco_train.json"
)

# val
cutom2coco(
    json_path="/HOME/scz0bdm/run/homework/balloon/val/via_region_data.json",
    img_prefix_path="/HOME/scz0bdm/run/homework/balloon/val",
    target_path="/HOME/scz0bdm/run/homework/balloon/val/coco_val.json"
)
